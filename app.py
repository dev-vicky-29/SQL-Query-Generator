...
def main():
    ...
    st.markdown(
        """
            ...
            <button href="app2.py" target="_blank" style="color: white; padding: 14px 20px; margin: 10px 0; border: none; cursor: pointer; width: 50%; text-align: center; font-size: 16px;">Updated Database Query Generator</button>
            </div>
        """,
