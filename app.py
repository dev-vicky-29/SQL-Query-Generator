...
def main():
    ...
    st.markdown(
        """
            ...
            <a src="app2.py" target="_blank" style="color: black; padding: 14px 20px; margin: 10px 0; border: none; cursor: pointer; width: 40%; text-align: center; font-size: 16px;">Updated Database Query Generator</a>
            </div>
        """,
